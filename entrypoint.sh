...
UUID=${UUID:-'5eca31e8-be00-4b65-8f00-00043a31f885'}
VMESS_WSPATH=${VMESS_WSPATH:-'/vmess-ray272449844'}
VLESS_WSPATH=${VLESS_WSPATH:-'/vless-ray272449844'}
TROJAN_WSPATH=${TROJAN_WSPATH:-'/trojan-ray272449844'}
SS_WSPATH=${SS_WSPATH:-'/shadowsocks-ray272449844'}
